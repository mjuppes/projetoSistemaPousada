...
<script>
	...
	var objectConfig = 
	{
		'gridDiv' : 'tabelaAuditoria',
		'width': 100,
		'class' : 'tabelaPadrao',
		'border':1,
		'id':'id_lanca_auditoria',
		'colspan':6,
		'push':'controle_auditoria.php'
	};

	$(document).ready(function(){
		var jq17 = jQuery.noConflict();
		getJsonSelect('selectTableLancamentoAuditoria',false,objectConfig,objectLabel);
	});
</script>
<body>
<div>
...
<form action="viewPousada.php" name="formLancamentoInsumo" id="formLancamentoInsumo" method="POST" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="form-actions">
		<button type="button" onclick="buscarTabelaLancamentoAuditoria()" class="btn" title="Buscar">
...
<fieldset class='moldura fieldAlertaLista'>
	<legend class='legend-2' style='background:#e5e5e5;border-radius:7px'><center><strong>Lista de Auditoria</strong></center></legend>
	<div id="tabelaAuditoria" style="width:99%;margin:0px 0.5%;"></div>
</fieldset>
</body>
</html>