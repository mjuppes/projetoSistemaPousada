...
class geraMetodos
{
	public function geraMetodos($strSQL=false)
	{
	...
	private function gerarJavascript($arrTabelasColunas,$tabela)
	{
		...
		$fp = fopen(DIR_PADRAO_METODOS."tabela.js", "w+");
	...
	private function gerarView($arrTabelasColunas,$tabela)
	{
		...
		$fp = fopen(DIR_PADRAO_METODOS."view.php", "w+");
	...
	private function gerarModel($arrTabelasColunas,$tabela)
	{
		...
		if(file_exists(DIR_PADRAO_METODOS.$arquivo))
		{
			$file = DIR_PADRAO_METODOS.$arquivo;
			$newfile = DIR_PADRAO_METODOS_BKP.$arquivo.".bak";
			copy($file, $newfile);
		}

		$fp = fopen(DIR_PADRAO_METODOS.$arquivo, "w+");
		$strClass   = "<?php\n";
	...
	private function gerarController($arrTabelasColunas,$tabela)
	{
		...
		$strClass .= "	public function controller".$tabela."(".chr(36)."action)\n";
		$strClass .= "	{\n";
