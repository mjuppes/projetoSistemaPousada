...
<form action="viewPousada.php" name="formInserirLancaInsumo" id="formInserirLancaInsumo" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <fieldset class='moldura fieldAlerta'>
		 	<legend class='legend-2' style='background:#e5e5e5;border-radius:7px'><center><strong>Cadastro de Consumo Interno</strong></center></legend>
			<div class="control-group">
				<label class="control-label" for="formSelectProduto"><strong>Produto:<strong></label>
					<div class="controls">
						...
						<button class="btn" href='#myModal' role='button' title='Visualizar'  data-toggle='modal' onclick='mostraProdutosInsumo();' >
			...
			<div class="form-actions form-background">
				<button type="button" onclick="cadastrarLancamentoInsumo();" class="btn btn-primary" id="formLancaInsumo_submit" name="formLancaInsumo_submit">Cadastrar</button>  
			</div>
		  <input type="hidden" id="formIdLancaInsumo" value="">
        </fieldset> 
</form>
<div style="width:100%">
<div id="myModal"  style="left:35%;margin-right:60%;width:70%;" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<button class="btn" type="button"	onclick="mostraProdutosInsumo()" title='Visualizar'>
				<img width="20px" height="20px" src="../icones/busca.png">
				<strong>Pesquisar</strong>
			</button>
		</div>
	...
	<div class="form-actions form-background">
		<button type="button" onclick="incluirInsumo();"  class="btn btn-primary" id="formProduto_submit" name="formProduto_submit">Confirmar</button>  
	</div>
