...
<div style="margin-left:10px;" >
  <input type="image" src="http://177.70.26.45/beaverpousada/icones/volta.png" name="image" width="40" height="40" onclick="javascript:history.go(-1);"> <strong>Voltar</strong>
</div>
<br>
<div id="tabelaFormularioPesquisa" style="width:99%;margin:0px 0.5%;"></div>
</body>
</html>