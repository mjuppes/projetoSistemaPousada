...
<?php include('../'.DIR_CLASSES.'controllerUNIDADE.php');?>
<?php include('../'.DIR_CLASSES.'controllerTIPO_FORNECEDOR.php');?>
<?php include('../'.DIR_CLASSES.'controllerMOV_ESTOQUE.php');?>
<?php include('../'.DIR_CLASSES.'controllerSUB_MENU.php');?>
<?php include('../'.DIR_CLASSES.'controllerLANCAMENTO_INSUMO.php');?>
<?php include('../'.DIR_CLASSES.'controllerLANCAMENTO_AUDITORIA.php');?>
<?php include('../'.DIR_CLASSES.'controllerBANDEIRA.php');?>
<?php include('../'.DIR_CLASSES.'controllerCHEQUE.php');?>
<?php include('../'.DIR_CLASSES.'controllerBANCOS.php');?>
<?php include('../'.DIR_CLASSES.'controllerDEPOSITO_CONTA.php');?>
<?php include('../'.DIR_CLASSES.'controllerCAT_CENTRO.php');?>
<?php include('../'.DIR_CLASSES.'controllerCENTRO_CUSTO.php');?>
<?php include('../'.DIR_CLASSES.'controllerSUB_CAT_CENTRO.php');?>
<?php include('../'.DIR_CLASSES.'controllerCONTATOS.php');?>
<?php include('../'.DIR_CLASSES.'controllerPESQUISA_CONTATO.php');?>
<?php include('../'.DIR_CLASSES.'controllerRESERVA_HOSPEDE.php');?>