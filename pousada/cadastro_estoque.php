...
$(document).ready(function(){
	...
	if($.query.get('idestoque') && $.query.get('editar'))
	{
		updateEstoque($.query.get('idestoque'));
		return;
	}
...
<br>
<div class="erros"></div>
<form action="viewPousada.php" name="formInserirEstoque" id="formInserirEstoque" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <fieldset class='moldura fieldAlerta'>
			<legend class='legend-2' style='background:#e5e5e5;border-radius:7px'><center><strong>Cadastro de Estoque</strong></center></legend>
			...
			<div class="control-group">
				<label class="control-label" for="formSelectProduto"><strong>Produto:<strong></label>
					<div class="controls">
						...
						<button class="btn" type="button" href='#myModal' role='button' title='Visualizar'  data-toggle='modal' onclick='mostraProdutosEstoque();' >
			...
			<div class="control-group">
				<label class="control-label"  disabledfor="formSelectSigla" disabled><strong>Sigla de Controle:<strong></label>
				<div class="controls">
					<select id="formSelectSigla"  disabled style="width:32%;" name="formSelectSigla">
					</select>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="formQtd"><strong>Quantidade:</strong></label>
				<div class="controls">
					<input type="text" class="input-xlarge" style="width:10%;" name="formQtd" id="formQtd">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label" for="formObservacao"><strong>Observação:</strong></label>  
				<div class="controls">
					<textarea class="input-xlarge" name="formObservacao" id="formObservacao" cols="50" rows="10"></textarea>  
				</div>
			</div>
			<div class="form-actions form-background">
				<button type="button" class="btn btn-primary" onclick="cadastrarEstoque();" id="formEstoque_submit" name="formEstoque_submit">Cadastrar</button>  
			</div>
		  <input type="hidden" id="formIdEstoque" value="">
        </fieldset> 
</form>
	...
	<div id="myModal"  style="left:35%;margin-right:60%;width:70%;" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<button class="btn" type="button"	onclick="mostraProdutosEstoque()" title='Visualizar'>
					<img width="20px" height="20px" src="../icones/busca.png">
					<strong>Pesquisar</strong>
				</button>
			</div>
		...
		<div class="form-actions form-background">
			<button type="button" onclick="incluirProdEstoque();"  class="btn btn-primary" id="formProduto_submit" name="formProduto_submit">Confirmar</button>  
		</div>
