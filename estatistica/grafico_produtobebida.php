...
<form class="form-horizontal" name="formProdutos" id="formProdutos" >
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="formSelectTipoBebida"><strong>Tipo de bebida<strong></label>
			<div class="controls">
				<select id="formSelectTipoBebida" style="width:21%;" name="formSelectTipoBebida"  >
					<option value="">Selecione um tipo de bebida</option>
				</select>
			</div>
		</div>
		<div class="form-actions">  
			<button type="button" class="btn btn-primary" onclick="gerarChartProdutoBebida();"  id="formFiltroProduto_submit" name="formFiltroProduto_submit">Gráfico</button>  
		</div>
   </fieldset>
</form>
